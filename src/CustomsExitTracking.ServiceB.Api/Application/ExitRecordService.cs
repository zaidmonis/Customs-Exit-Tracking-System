    ...
    IExitRecordRepository exitRecordRepository)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await exitRecordRepository.UpdateAsync(person.PersonId, request, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await exitRecordRepository.DeleteAsync(person.PersonId, exitId, cancellationToken);
    }
}
